...
const TIERS = [
  {
    ...
    features: ['Up to 25 people', '1 category', 'Current and target levels', 'Invite your team'],
    cta: 'Start free',
    featured: false,
  },
  {
    ...
    features: ['Up to 100 people', 'Unlimited categories', 'Insights dashboard', 'Roles and permissions'],
    cta: 'Start free',
    featured: true,
  },
  {
